...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNavMain">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item ms-3">
                      ...
                      <input type="text" name="search" placeholder="Search..." class="form-control me-2" required>
    ...
    <!-- Hero Section -->
    <section class="hero text-center text-white" style="height: 70vh;">
        <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="images/animation.jpg" class="d-block w-100" alt="Hero Image 1">
                </div>
                <div class="carousel-item">
                    <img src="images/site image.jpeg" class="d-block w-100" alt="Hero Image 2">
                </div>
                <div class="carousel-item">
                    <img src="images/site_image2.jpg" class="d-block w-100" alt="Hero Image 3">
                </div>
                <div class="carousel-item">
                    <img src="images/worksite.jpg" class="d-block w-100" alt="Hero Image 4">
                </div>
                <div class="carousel-item">
                    <img src="images/worksite2.jpg" class="d-block w-100" alt="Hero Image 5">
                </div>
                <div class="carousel-item">
                    <img src="images/worksite3.jpg" class="d-block w-100" alt="Hero Image 6">
                </div>
            </div>
        ...
        <!-- Overlay Content -->
        <div class="hero-overlay d-flex flex-column justify-content-center align-items-center position-absolute top-50 start-50 translate-middle">
            <h1>Welcome to BuildCore</h1>
            <p>Your Trusted Partner in Construction Materials</p>
            <a href="ai.html" class="btn btn-primary">Get AI Estimation</a>
        </div>
    </section>
...
<section class="container my-5">
    ...
    <div class="row">
        ...
        // Fetch products
        $sql = "SELECT id, name, image, price, unit FROM products ORDER BY id ASC";
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow">
                        ...
                        <div class="card-body text-center">
                            ...
                            <a href="register.php?product=' . urlencode($row["name"]) . '" class="btn btn-primary mt-2">
                                Purchase Now
                            </a>
                        </div>
                    </div>
    ...
    <section class="container my-5">
        ...
        <div class="row text-center">
            <div class="col-md-4">
                <img src="images/service2.jpg" alt="Service 1" class="img-fluid rounded-circle">
                <h4>AI Estimation</h4>
                <p>Material estimation with AI.</p>
            </div>
            <div class="col-md-4">
                <img src="images/service4.jpg" alt="Service 2" class="img-fluid rounded-circle">
                <h4>Quality Products</h4>
                <p>We provide high-quality construction materials.</p>
            </div>
            <div class="col-md-4">
                <img src="images/service3.png" alt="Service 3" class="img-fluid rounded-circle">
                <h4>Real-Time Support</h4>
                <p>24/7 support to guide you in your construction needs.</p>
            </div>
        </div>
    </section>
    ...
    <section class="features bg-light py-5">
        <div class="container">
            <h2 class="text-center mb-4">Why Choose BuildCore?</h2>
            <div class="row text-center">
                <div class="col-md-3">
                    <i class="bi bi-speedometer2" style="font-size: 2rem;"></i>
                    <h5>Fast Estimation</h5>
                </div>
                <div class="col-md-3">
