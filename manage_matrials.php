...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_material'])) {
    ...
    $cement_price = $_POST['cement_price'];
    $iron_price = $_POST['iron_price'];
    $image = $_FILES['image']['name'];
    $target = "images/" . basename($image);

    // Move the uploaded file to the images directory
    if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
        $sql = "INSERT INTO materials (name, price, type, unit, unit_cost, cement_price, iron_price, image) 
                VALUES ('$name', '$price', '$type', '$unit', '$unit_cost', '$cement_price', '$iron_price', '$image')";
...
<html lang="en">
<head>
    <title>BuildCore - Manage Materials</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <a class="navbar-brand" href="admin_dashboard.php">
                <img src="images/material.jpeg"cghange password Logo" width="50" height="50" class="rounded-circle">Admin
        </a>
    ...
    <section class="container my-5">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="cement_price" class="form-label">Cement Price</label>
                <input type="number" class="form-control" id="cement_price" name="cement_price" required>
            </div>
            <div class="mb-3">
                <label for="iron_price" class="form-label">Iron Price</label>
                <input type="number" class="form-control" id="iron_price" name="iron_price" required>
            </div>
            <div class="mb-3">
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                            ...
                            <td>" . $row['unit'] . "</td>
                            <td>₨" . $row['unit_cost'] . "</td>
                            <td>₨" . $row['cement_price'] . "</td>
                            <td>₨" . $row['iron_price'] . "</td>
                            <td><img src='images/" . $row['image'] . "' alt='Material Image' width='100'></td>
                            <td><a href='manage_materials.php?id=" . $row['id'] . "' class='btn btn-danger'>Remove</a></td>
                          </tr>";
                }
                ?>
            </tbody>
